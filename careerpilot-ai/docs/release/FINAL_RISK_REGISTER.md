...
| R3 | Ollama streaming response parsing mismatch | Low | FIXED | Provider now supports both stream=true NDJSON and stream=false JSON; live smoke test with llama3.1:latest returns structured data | CLOSED |
