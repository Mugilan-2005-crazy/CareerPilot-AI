        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleCreate(); }}>
          <label className="block">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-slate-800 bg-slate-950/70 px-4 py-3">
              ...
              <input value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Aarav Kumar" className="w-full bg-transparent outline-none" />
            </div>
          </label>
          <label className="block">
          ...
          <label className="block">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-slate-800 bg-slate-950/70 px-4 py-3">
              ...
              <input value={password} onChange={(e) => setPassword(e.target.value)} type="password" placeholder="Create a strong password" className="w-full bg-transparent outline-none" />
            </div>
          </label>
