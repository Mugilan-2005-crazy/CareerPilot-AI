 ...
 * - /api/v1/ai-career/* - Career intelligence endpoints (AUTHENTICATED with JWT)
 * 
 ...
 * - /api/ai-career/* - Career intelligence endpoints
 * - Other resources continue at /api/*
 * 
 * Migration: Clients should transition to /api/v1/* with Bearer tokens
 */
...
router.use('/domains', createResourceRoutes(Domain, createResourceController(Domain, { searchFields: ['name', 'description'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/skills', createResourceRoutes(Skill, createResourceController(Skill, { searchFields: ['name', 'description'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/careers', createResourceRoutes(Career, createResourceController(Career, { searchFields: ['name', 'description'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/projects', createResourceRoutes(Project, createResourceController(Project, { searchFields: ['title', 'description'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/learning-resources', createResourceRoutes(LearningResource, createResourceController(LearningResource, { searchFields: ['title', 'description', 'type'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/job-matches', createResourceRoutes(JobMatch, createResourceController(JobMatch, { searchFields: ['career'], ownerField: 'user' }), { readRoles: ['student', 'admin'], writeRoles: ['student', 'admin'] }));
router.use('/roadmaps', createResourceRoutes(Roadmap, createResourceController(Roadmap, { searchFields: ['title', 'description'], ownerField: 'user' }), { readRoles: ['student', 'admin'], writeRoles: ['student', 'admin'] }));
router.use('/aptitude-questions', createResourceRoutes(AptitudeQuestion, createResourceController(AptitudeQuestion, { searchFields: ['question', 'topic', 'tags'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/technical-questions', createResourceRoutes(TechnicalQuestion, createResourceController(TechnicalQuestion, { searchFields: ['title', 'topic', 'tags'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/communication-questions', createResourceRoutes(CommunicationQuestion, createResourceController(CommunicationQuestion, { searchFields: ['prompt', 'topic', 'tags'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
router.use('/coding-questions', createResourceRoutes(CodingQuestion, createResourceController(CodingQuestion, { searchFields: ['title', 'topic', 'tags'], ownedByCurrentUser: false }), { readRoles: ['student', 'admin'], writeRoles: ['admin'] }));
